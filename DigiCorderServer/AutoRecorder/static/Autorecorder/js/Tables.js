    ...
    try{
        ...
        <div id = ${num_errors_str}>
            <div class="alert alert-danger" role="alert" onclick = "removeAllChildNodes(document.getElementById(${num_errors_str}))">
                ...
                Error in rxNextTOMessage Function
            </div>
        </div>
        `)
    }
...
function nextTOMessage(chatSocket, id, runway) {
    try{
        ...
        <div id = ${num_errors_str}>
            <div class="alert alert-danger" role="alert" onclick = "removeAllChildNodes(document.getElementById(${num_errors_str}))">
                <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                Error in NextTOMessage Function
            </div>
        </div>
        `)
    }
...
//<script>var error_msg = document.getElementById('error_message')</script> 
//<div id = num_errors_str>
//<div class="alert alert-danger" role="alert" onclick = "removeAllChildNodes(num_errors_str)">
//    <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
//    Error in NextTOMessage Function
//</div>
//</div>
